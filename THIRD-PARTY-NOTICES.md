...
The outline icons in `CaveStudioEdge/scripts/views/icons.js` are adapted from
...
`CaveStudioEdge/common/plugins/*.js` are Corsair's official iCUE widget API wrappers,
included as the iCUE widget framework requires.
